...
global CTN_Minimize_Button:=[]

; Create_Minimize_Button("x:=20", "y:=20", "w:=20", "h:=20")
; Create_Minimize_Button("x:=60", "y:=20", "w:=40", "h:=40")
; Create_Minimize_Button("x:=120", "y:=20", "w:=80", "h:=80")
; Create_Minimize_Button("x:=220", "y:=20", "w:=160", "h:=160")
; Create_Minimize_Button("x:=420", "y:=20", "w:=320", "h:=320")


; Gui, 1:Color, green
; Gui, 1:Show, w800 h400
SetTimer, CTN_Hover_Function_Minimize, 20
; return

Create_Minimize_Button(params*) {
    ;================DEFAULTS================
        x:=10,
        y:=10,
        w:=100,
    ...
    CTN_Minimize_Button.Push(New Minimize_Button(x, y, w, h, Color1, Color2, OutBorder_C1, OutBorder_C2, InBorder_C1, InBorder_C2, InShadow_C1, InShadow_C2, OutShadow_C1, OutShadow_C2, Cross_Shadow_Off, Hover_C1, Hover_c2, Hover_OutBorder_C1, Hover_OutBorder_C2, Hover_InBorder_C1, Hover_InBorder_C2, Pressed_C1, Pressed_C2, Pressed_OutBorder_C1, Pressed_OutBorder_C2, Pressed_InBorder_C1, Pressed_InBorder_C2,  Text, Font, Font_Size, Font_Color_Top, Font_Color_Bottom,  Window, Label, Radius, Border_Width, BakcgroundColor))
}


CTN_Hover_Function_Minimize(){
	static Hover_On, Index
	MouseGetPos,,,,ctrl, 2
	if ( ! Hover_On && ctrl) {
		loop, % CTN_Minimize_Button.Length() {
			if (ctrl=CTN_Minimize_Button[A_Index].Hwnd) {
				CTN_Minimize_Button[A_Index].Draw_Hover()
				Hover_On:=1
				Index:=A_Index
				break
			}
		...
		if ( ctrl != CTN_Minimize_Button[Index].Hwnd) {
			CTN_Minimize_Button[Index].Draw_Default()
			Hover_On:=0
		}
}
...
Class Minimize_Button {
    ...
    Create_Default_Bitmap() {
        ...
        Gdip_FillRectangle( G , Brush , This.W/40 , This.W/40 , This.W*1.04 , This.H*1.04 )
        Gdip_DeleteBrush( Brush )
        ...
        Gdip_DrawLine( G , Pen , This.W/4.21 , This.W-(This.W/13.33) , This.W , This.W-(This.W/13.33) )
        ;Gdip_DrawLine( G , Pen , 34 , 84 , 94 , 84 )
        Gdip_DeletePen( Pen )
        
        ;================Line================
        Pen := Gdip_CreatePen( "0xFFFFFFFF" , This.W/8 )
        Gdip_DrawLine( G , Pen , This.W/5.33 , This.W-(This.W/8) , This.W-(This.W/16) , This.W-(This.W/8) )
        ;Gdip_DrawLine( G , Pen , 15 , 70 , 75 , 70 )
        Gdip_DeletePen( Pen )
    ...
    Create_Hover_Bitmap() {
        ...
        ;================Line================
        Pen := Gdip_CreatePen( "0xFFFFB200" , This.W/8 )
        Gdip_DrawLine( G , Pen , This.W/5.33 , This.W-(This.W/8) , This.W-(This.W/16) , This.W-(This.W/8) )
        ;Gdip_DrawLine( G , Pen , 15 , 70 , 75 , 70 )
        Gdip_DeletePen( Pen )
        Gdip_DeleteGraphics( G )
    ...
    Create_Pressed_Bitmap() {
        ...
        ;================Line================
        Pen := Gdip_CreatePen( "0xFF00FFFF" , This.W/8 )
        Gdip_DrawLine( G , Pen , This.W/5.33 , This.W-(This.W/8) , This.W-(This.W/16) , This.W-(This.W/8) )
        ;Gdip_DrawLine( G , Pen , 15 , 70 , 75 , 70 )
        Gdip_DeletePen( Pen )
        Gdip_DeleteGraphics( G )
    ...
    Draw_Pressed(){
		SetTimer,CTN_Hover_Function_Minimize,Off
		SetImage(This.hwnd, This.Pressed_Bitmap)
		While(GetKeyState("LButton"))
			Sleep,10

		SetTimer,CTN_Hover_Function_Minimize,On
		MouseGetPos,,,,ctrl,2
