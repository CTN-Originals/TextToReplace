	...
	;______ Modifications from Original code ______:

	;Scroll Gui Windows with Mouse Wheels:
	; - Click "Mouse Middle Button" \ - Left Click on Gui windows scroll bars \ - Left Click on any Gui windows blank areas or non-client areas
...
Gui, TestScroll:Default		;__________ Test Scroll Gui ____________
...
gui, show, w400 h250, Controls Scroll (Test)
...
#IfWinActive ahk_group MyGui	;__________ Hotkeys below this line are only for this script gui windows _____________
