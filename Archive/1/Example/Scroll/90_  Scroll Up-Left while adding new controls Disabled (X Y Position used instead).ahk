...
UpdateScrollBars(A_Gui, Gui%A_Gui%Width, Gui%A_Gui%Height, , 20, 20)	;"20" "RightMargin" and "BottomMargin" = 20 (must be the same value for any "UpdateScrollBars()" in use)
