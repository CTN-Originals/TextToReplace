...
gui, add, button, vAdd gAdd, Add (no bug)
gui, add, button, x+5 gAdd2, Add2 (with bug)
...
Add:	;_________________Add Button__________

gosub, ScrollUpLeft	;prevents blank spaces

gui, add, edit, x+5 y8 w50,	;from 8 and above, no problems detected

	;gui, add, edit, x+100 y0 w50,	;y0 causes problem while addig horizontaly (0 to 7 causes problems)

	;gui, add, edit, x+100 ym w50,	;ym causes problem while addig horizontaly

	;gui, add, edit, ys w50,		;ys causes problem while addig horizontaly

	;msgbox, % Gui%A_Gui%Width " - " Gui%A_Gui%Height " \ " A_GuiWidth " - " A_GuiHeight
...
Add2:	;__________ Add 2 Button____________________

gosub, ScrollUpLeft	;prevents blank spaces

gui, add, edit, x+5 y0 w50,	;ys, ym, y(0 to 7) cause problems
...
GuiSize:	;_________Gui Size________
...
ScrollUpLeft:	;________Scroll Up / Left Edge_______
...
ScrollDown:	;________Scroll Down Edge_______
sleep 50
