...
{	
if a_index = 1
gui, add, edit, x+5 y10 w50 vC%Column%L%a_index% gRealTimeOutput, C%Column%L%a_index%	;ys, ym, y(0 to 7) 
else
...
GuiSize:
	...
	;msgbox %A_GuiNum%
	;msgbox, %ScrollBars% %Gui%  %GuiWidth%  %GuiHeight% 
	;msgbox, %ScrollBars% %A_Gui%  %A_GuiWidth%  %A_GuiHeight% 
return
...
ScrollDownRight:	;________Scroll Down / Right Edge_______
sleep 50
...
+WheelDown::
	...
	;msgbox, %cX%  %cY% %cW%  %cH% %Left% %Top% %Right% %Bottom%	
	;msgbox, %c% %X%  %Y% %W%  %H% %Left% %Top% %Right% %Bottom%
return
#IfWinActive
